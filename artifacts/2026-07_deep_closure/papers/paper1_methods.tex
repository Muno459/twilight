...
the REFEREE's own Monte Carlo error rather than the model's (measured
across the tier: referee relative standard error 5.9 to 10.7 percent
against the model's 2.5 to 5.9 percent, with the referee the larger term
in fifteen of sixteen cells). This is a weaker statement than the
...
relative seed standard error runs from 2.5 to 5.9 percent (one
...
would narrow them only to 12 to 35 percent. Additional model seeds
...
fresh-seed $10^9$-photon replicas by inverse variance tightens the
four refereed $\tau^{*}=3$ cells from 6.1--10.6 to 3.6--5.7 percent and
narrows the affected bands by 24 percent, with every verdict unchanged
and four of six ratios moving toward unity. The same pooling permits a
...
meaning three independent $10^9$-photon estimates of one quantity
disagree about 2.1 times more than their own error bars allow. That is
